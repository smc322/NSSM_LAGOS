...
#save data files
setwd("~/Dropbox/Sarah_Work/Research/SeedGrant_LAGOSspatialmodels/Data/16Jan2019")
dat<-na.omit(read.csv("LagosNonSecchi_16Jan2019.csv"))
...
#setwd back to project
setwd("~/Documents/LocalGitProjects/NSSM_LAGOS")

pdf("Figures/Fig1_mapsviolins.pdf", width=6, height=6)
...
pdf("Figures/Fig1_boxplotinset.pdf", width=4, height=2.5)
