...
#Code for running GAMs and creating Figure 2
#Example run for TP in Northeastern region:
...
###################### Figure 2 ############################
#GAM output for all regions and responses is summarized in plot_gams.csv

install.packages("plotrix")
library(plotrix)
g<-read.csv("Data/ModelOutput/plot_gams.csv")

png(filename="Figures/Fig2_GAM.png", width=8, height=8, units='in', res=300)
...
legend('topright', pch=c(0,1,2,15,16,17), bty="n", cex=1.5, c( "Urban - Midwest", "Urban - New York", "Forest - Midwest","Forest - New York", "N deposition - Midwest", "N deposition - New York"))
